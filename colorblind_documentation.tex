...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \fill[yellow] (10*\dx,0) circle (\radius);
        \fill[red!50!green] (11*\dx,0) circle (\radius);
        ...
        \fill[yellow, rounded corners=0.7*\radius cm]
            (10*\dx-\radius,\dy-0.7*\radius) rectangle ++(2*\radius, 1.4*\radius);
        \fill[red!50!green, rounded corners=0.7*\radius cm]
            (11*\dx-\radius,\dy-0.7*\radius) rectangle ++(2*\radius, 1.4*\radius);
        }
        ...
        \fill[yellow, rounded corners=0.7*\radius cm]
            (10*\dx-\radius,1.8*\dy-0.7*\radius) rectangle ++(2*\radius, 1.4*\radius);
        \fill[red!50!green, rounded corners=0.7*\radius cm]
            (11*\dx-\radius,1.8*\dy-0.7*\radius) rectangle ++(2*\radius, 1.4*\radius);
        }
    \end{tikzpicture}
