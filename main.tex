...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \fill[T_B_Q1] (0,0) circle (\radius);
        \fill[T_B_Q2] (\dx,0) circle (\radius);
        \fill[T_B_Q3] (2*\dx,0) circle (\radius);
        \fill[T_B_Q4] (3*\dx,0) circle (\radius);
        \fill[T_B_Q5] (4*\dx,0) circle (\radius);
        \fill[T_B_Q6] (5*\dx,0) circle (\radius);
        \fill[T_B_Qgrey] (6*\dx,0) circle (\radius);
